...
elseif strcmp(annot_Team,'Technical') | strcmp(annot_Team,'sandbox')
...
wv_fields_import =  {'waveform', 'wave_norm', 'sps', 'T', 'Valid', 'label'};
...
% Oxy2R
annot_opts_rawPPG = {'valid', 'artifact','weak signal'};
