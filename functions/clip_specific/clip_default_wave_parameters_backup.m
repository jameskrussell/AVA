...
%% patient:
 ...
 color_cpr = {{'green', 'red', 'blue'}};  %order same as annot_cpr
...
%ECG1
  color_ECG1 = 'blue';
  label_ECG1 = 'ECG';
  annot_opts_ECG1 = {'VF', 'VT', 'Organized','Asystole-org','Asystole-vf', ...
     'Asystole-NOS', 'Rhythm Unknown', 'ECG Artifact'};
  fill_ECG1 = struct(...
     'red', {{'VF', 'VT'}},...
     'green', {{'Organized'}}, ...
     'yellow', {{'Asystole', 'Asystole-org', 'Asystole-vf', 'Asystole-NOS'}}, ...
     'black', {{'Shock Start'}}, ...
     'white', {{'Rhythm Unknown', 'Shock End', 'End wave'}}, ...
     'blue', {{'ECG Artifact', 'Start wave' }}); %note double brackets to make struct with cell array as field
  yview_ECG1 = 'raw'; 
  ylimit_def_ECG1 = [-2 2];  
  may_shift_ECG1 = 0;
  meas_ECG1 = struct(...
         'label', {'flats', 'clas', 'pk2pk', 'SD'}, ...
         'color', {'black', 'blue', 'magenta', 'red'}, ...
         'marker', {'+', '*', '.', 'x'}, ...
...
%  yview_PCI = 'raw';  ylimit_def_PCI = [0 10000];  
  yview_PCI = 'zeromean'; ylimit_def_PCI = [-5000 5000];    
...
%  yview_FORC = 'raw'; ylimit_def_FORC = [0 50000];  
  yview_FORC = 'zeromean'; ylimit_def_FORC = [-50 50];  
